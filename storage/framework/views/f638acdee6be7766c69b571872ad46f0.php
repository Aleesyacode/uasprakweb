...
<div class="container my-5">
    ...
    <form method="POST" action="<?php echo e(route('journals.store')); ?>">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                ...
                <?php $__currentLoopData = ['Happy', 'Sad', 'Angry', 'Calm', 'Anxious', 'Excited']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mood): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($mood); ?>" <?php echo e(old('mood') == $mood ? 'selected' : ''); ?>><?php echo e($mood); ?></option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="d-flex flex-wrap gap-3">
                <?php $__currentLoopData = $activityList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="activities[]" value="<?php echo e($activity); ?>" id="activity_<?php echo e($activity); ?>"
                        <?php echo e(is_array(old('activities')) && in_array($activity, old('activities')) ? 'checked' : ''); ?>>
        ...
        <div class="mb-3">
            ...
            <textarea name="to_do_list" class="form-control"><?php echo e(old('to_do_list')); ?></textarea>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\Mood-Tracker\mood-tracker\resources\views/journals/create.blade.php ENDPATH**/ ?>